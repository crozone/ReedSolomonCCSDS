...
{
    public class FixedConventionalTests
    {
        private readonly ITestOutputHelper output;

        /// <summary>
        /// A precalculated RS8 encoded block in conventional form. First 223 bytes are test data, last 32 bytes are the corresponding parity.
        /// </summary>
        ...
        public FixedConventionalTests(ITestOutputHelper output)
        {
            this.output = output;
        }
