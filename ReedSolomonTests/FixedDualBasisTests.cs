...
{
    public class FixedDualBasisTests
    {
        private readonly ITestOutputHelper output;

        /// <summary>
        /// A precalculated RS8 encoded block in dual-basis form. First 223 bytes are test data, last 32 bytes are the corresponding parity.
        /// </summary>
        private static readonly Memory<byte> goodBlock = new byte[Rs8.BlockLength] {
            ...
            0xD0, 0xD1, 0xD2, 0xD3, 0xD4, 0xD5, 0xD6, 0xD7, 0xD8, 0xD9, 0xDA, 0xDB, 0xDC, 0xDD, 0xDE, 0x4F,
            0xFB, 0x92, 0xDD, 0x55, 0x7E, 0xC6, 0x7F, 0x27, 0xFB, 0x89, 0x82, 0xCF, 0x58, 0xF8, 0xFD, 0x02,
            0x8A, 0xD1, 0x17, 0xFC, 0xEF, 0x6B, 0x27, 0x93, 0xD0, 0x41, 0x88, 0x26, 0x57, 0x86, 0x51
        };

        public FixedDualBasisTests(ITestOutputHelper output)
        {
            this.output = output;
        }
